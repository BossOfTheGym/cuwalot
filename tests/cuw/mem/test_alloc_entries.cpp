...
namespace {
	int test_byte_entry() {
		...
		constexpr std::size_t total_chunks = 2;
		constexpr std::size_t total_pools = 4;
		constexpr std::size_t pool_capacity = total_chunks * mem::byte_pool_t::max_chunks;
		constexpr std::size_t pool_size = sizeof(mem::byte_pool_t) * total_chunks;
		...
		alignas(sizeof(mem::byte_pool_t)) std::uint8_t data[total_memory] = {};
		...
		std::cout << "testing byte_pool_entry_t..." << std::endl;
